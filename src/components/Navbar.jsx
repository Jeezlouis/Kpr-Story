...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <div 
                ref={backgroundRef}
                className="fixed inset-0 z-[100] bg-white/80 backdrop-blur-sm hidden opacity-0"
                style={{ display: 'none' }}
                onClick={toggleMenu}
            />
            ...
            <div className='fixed inset-0 z-50 pointer-events-none'>
                <div className='w-full px-6 pt-6 pointer-events-none'>
                    <nav className='border-[0.5px] border-gray-25 overflow-hidden rounded-xl pointer-events-none'>
                        ...
                        <div className="absolute h-full px-3 flex flex-col items-center border-r border-gray-25">
                            <div className='mt-auto mb-auto'>
                                <a href="/" rel="noopener noreferrer" className="pointer-events-none">
                                    <svg 
